...
class LaboursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create labour" do
    assert_difference('Labour.count') do
      post labours_url, params: { labour: { amount: @labour.amount, descrp: @labour.descrp, name: @labour.name, nr_inv: @labour.nr_inv } }
    end
  ...
  test "should update labour" do
    patch labour_url(@labour), params: { labour: { amount: @labour.amount, descrp: @labour.descrp, name: @labour.name, nr_inv: @labour.nr_inv } }
